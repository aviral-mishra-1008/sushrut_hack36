...
import numpy as np
import cv2
from .Face_signatures.Models.FaceNet_third_model_proposition_using_preTrained_fineTuning import *
from sklearn.preprocessing import Normalizer
import os
from .Face_signatures.src.anti_spoof_predict import AntiSpoofPredict
from .Face_signatures.src.generate_patches import CropImage
from .Face_signatures.src.utility import parse_model_name

l2_normalizer = Normalizer('l2')
# Get the directory of this file and construct path to haarcascade
current_dir = os.path.dirname(os.path.abspath(__file__))
haarcascade_path = os.path.join(current_dir, 'Face_signatures', 'haarcascade_frontalface_default.xml')
detector = cv2.CascadeClassifier(haarcascade_path)
model = Embed_model()

model_dir = os.path.join(current_dir, "Face_signatures", "resources", "anti_spoof_models")
